...
pub fn init(alloc: std.mem.Allocator, option: PathOption) !Self {
...
pub fn resolve_path(self: *const Self, alloc: std.mem.Allocator) ![]u8 {
    switch (self.path) {
        .ExeRelative => |v| {
...
pub fn resolve_path_c_str(self: *const Self, alloc: std.mem.Allocator) ![:0]u8 {
