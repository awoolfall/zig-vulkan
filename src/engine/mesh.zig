...
pub const Model = struct {
    ...
    pub fn init_from_shape(alloc: std.mem.Allocator, shape: *zmesh.Shape) !Model {
        ...
        mn[0] = ModelNode {
            .mesh_set = MeshSet {
                .primitives = .{0} ** MAX_PRIMITIVES_PER_SET,
                .num_primitives = 1,
